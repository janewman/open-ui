...
- [`itemcontrols`](#v2-itemcontrols) - preserve an outer focusgroup item as the directional-navigation target while managing sequential access to its `focusgroup="none"` controls. The `feed` and `grid` behaviors imply this modifier.
