...
<p class="question">What key model would let any ARIA-feed behavior preserve the ARIA feed contract, and how would it interact with scrolling, loading, and virtualization?</p>
